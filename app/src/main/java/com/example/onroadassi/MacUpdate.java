...
public class MacUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mac_update);
...
//                String email1 = email.getText().toString();
                progressDialog =new ProgressDialog(MacUpdate.this);
    ...
    private void update(String id) {
                ...
                TextUtils.isEmpty(skill1))
        {
            ...
            Toast.makeText(MacUpdate.this,"Empty field Are not Allowed",Toast.LENGTH_SHORT).show();
        ...
        else if (content.getText().toString().length()<10 || content1.length()>10)
        {
            ...
            // am_checked=0;
            Toast.makeText(MacUpdate.this,"Enter correct Contect",Toast.LENGTH_SHORT).show();
        }
        else {
            db.collection("student").document(id).update("name",name1,"contact",content1,"city",city1,"district",district1,"skill",skill1).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(MacUpdate.this, "Successfully updated..", Toast.LENGTH_SHORT).show();
                    if (progressDialog.isShowing())
                        progressDialog.dismiss();
                    finish();
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(MacUpdate.this, "faille updated..", Toast.LENGTH_SHORT).show();
                    if (progressDialog.isShowing())
                        progressDialog.dismiss();
                }
            });}
