...
public class MacDash extends AppCompatActivity {
...
//    private FirebaseAuth auth; //connection code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mac_dash);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(MacDash.this,MacUpdate.class);
            ...
            public void onClick(View v) {
                FirebaseFirestore.getInstance().collection("student").whereEqualTo("email",str).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        progressDialog =new ProgressDialog(MacDash.this);
                        ...
                        b.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(MacDash.this,"sucess",Toast.LENGTH_SHORT).show();
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(MacDash.this,"fall",Toast.LENGTH_SHORT).show();
                                if (progressDialog.isShowing())
                                    progressDialog.dismiss();
                            }
                        });
    ...
    public void veryfy(View view) {
        Intent intent =new Intent(MacDash.this,MacFillUp.class);
        startActivity(intent);
