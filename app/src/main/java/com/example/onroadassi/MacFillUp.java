...
public class MacFillUp extends AppCompatActivity {
    //Location code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mac_fill_up);
...
//
                ...
                {
                    Toast.makeText(MacFillUp.this,"Empty field Are not Allowed",Toast.LENGTH_SHORT).show();
...
//                    }
                ...
                else if (content.getText().toString().length()<10 || content1.length()>10)
                {
                    ...
                    // am_checked=0;
                    Toast.makeText(MacFillUp.this,"Enter correct Contect",Toast.LENGTH_SHORT).show();
                }
//
                else{
                    progressDialog =new ProgressDialog(MacFillUp.this);
