...
public class PayGetway extends AppCompatActivity implements PaymentResultListener {
    EditText recha;
    TextView balans;
    Button re;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pay_getway);
        ...
        re.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    checkout.open(PayGetway.this, object);
